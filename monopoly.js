...
function closechoices(){
	...
	var hideandshows = document.querySelectorAll(".questionsHideAndShow")

	// hideandshows.forEach((value,index,arr)=>{
...
function results(){
	...
	var p = player[turn].position;
	// var hideandshows = document.querySelectorAll(".questionsHideAndShow")
	// var reversedHideandshows = Array.from(hideandshows).reverse();

	// reversedHideandshows.forEach((value,index,arr)=>{
